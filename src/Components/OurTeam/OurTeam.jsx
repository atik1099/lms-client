...
import person6 from '../../assets/team/person-1.jpg'
...
import person2 from '../../assets/team/person-6.jpeg'
        ...
        <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
          ...
          <div className="flex flex-col justify-center m-8 text-center">
            <img
              ...
              src={person1}
            />
            <p className="text-xl font-semibold leading-tight">Meherun Nesa</p>
            <p>Founder & CEO</p>
          </div>
          <div className="flex flex-row flex-wrap-reverse justify-center">
            <div className="flex flex-col justify-center m-8 text-center">
              <img
                ...
                src={person2}
              />
              <p className="text-xl font-semibold leading-tight">Atik Shahriar</p>
            ...
            <div className="flex flex-col justify-center m-8 text-center">
              <img
                ...
                src={person6}
              />
              <p className="text-xl font-semibold leading-tight">Farzana Akter</p>
