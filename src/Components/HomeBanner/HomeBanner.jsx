      ...
      <Carousel className="text-center">
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/4 left-10 md:left-20 z-10 text-left">
            ...
            <div className="flex gap-3 md:gap-5">
              <button className="btn bg-[#e67e22] border-none shadow-xl text-white md:text-lg mt-3 md:mt-5">
                <NavLink to="/public-classes">View Classes</NavLink>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/4 left-10 md:left-20 z-10 text-left">
            ...
            <button className="btn bg-[#e67e22] border-none shadow-xl text-white md:text-lg mt-3 md:mt-5">
            <NavLink to="/public-classes">Join Classes</NavLink>
            </button>
          </div>
        </div>
      </Carousel>
